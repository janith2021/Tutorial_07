...
{
  val account1= new BankAccount1("Janith",20000700,15000.00)
  val account2= new BankAccount1("Heshara",20000800,128000.00)
  val account3= new BankAccount1("Amal",20000900,2000.00)
  val account4= new BankAccount1("Perera",20000950,-4000.00)
